...
plt.title('Comparaison Hamiltonien',fontsize=18)
...
plt.legend()
plt.savefig('Comparaison_Hamiltonien_T4')
#plt.show()
...
plt.figure(figsize=(9.5,6.5), dpi=80)
plt.title('Conservation energie Hamiltonien',fontsize=18)
...
plt.legend()
plt.savefig('Conservation_energie_Hamiltonien_T20')
plt.show()